...
//var name = toLower('demo-${locationCode}-${projectCode}-${envCode}-vnet-${sequence}')
var name = toLower('demo-${projectCode}-${envCode}-vnet-${locationCode}-${sequence}')
...
resource virtualNetwork 'Microsoft.Network/virtualNetworks@2022-01-01' = {
  ...
  tags: {
    ...
    template : 'Demo-Operations_IaC Virtual network template'
  }
  properties: {
    addressSpace: {
      addressPrefixes: [
